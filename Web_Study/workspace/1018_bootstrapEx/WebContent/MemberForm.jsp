					...
					<tbody class="tbody">
						...
						<tr>
							...
							<td>
								<script>
									var today = new Date();
									var toyear = parseInt(today.getFullYear()); // 2021을 얻어옴!
									var start = toyear - 15; // 네이버인 경우 만14세 이상 회원가입 가능!
									var end = toyear - 80;
								...
								<div class="inputArea">
									...
									<p>
										...
										<input type="text" name="userAddr3" id="extraAddress"
										       size="48" placeholder="참고항목(도로명인 경우: 지역이름과 아파트이름)"/>
										<input type="text" name="userAddr2"
											   id="detailAddress" size="45"
											   placeholder="상세주소(아파트 동호수 또는 빌딩이름 입력하세요!)"/>
									</p>
